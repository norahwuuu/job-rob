...
$PY LinkedIn-Collect-main/run_pipeline.py status

echo "[2/4] Generate one resume"
$PY LinkedIn-Collect-main/run_pipeline.py generate --limit 1

echo "[3/4] Apply one easy todo entry"
$PY LinkedIn-Collect-main/run_pipeline.py apply --max 1
