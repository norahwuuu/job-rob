...
- `pipeline-orchestrator`  
  负责流程编排与主状态管理（crawl / generate / apply / status），主状态文件是 `artifacts/jobs_progress.json`。
...
```bash
bash pipeline-orchestrator/scripts/smoke_regression.sh
```
